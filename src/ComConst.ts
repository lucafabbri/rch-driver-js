export class ComConst {
    static readonly CHR_zero: number = 0x00;
    static readonly CHR_SOH: number = 0x01;
    static readonly CHR_STX: number = 0x02;
    static readonly CHR_ETX: number = 0x03;
    static readonly CHR_EOT: number = 0x04;
    static readonly CHR_ENQ: number = 0x05;
    static readonly CHR_ACK: number = 0x06;
    static readonly CHR_DLE: number = 0x16;
    static readonly CHR_NACK: number = 0x21;
    static readonly CHR_EM: number = 0x25;
    static readonly CHR_WAIT: number = 0x64;
    static readonly CHR_LF: number = 0x10;
    static readonly CHR_CR: number = 0x13;
    static readonly CHR_FS: number = 0x28;
    static readonly CHR_RS: number = 0x30;
    static readonly CHR_NULL: number = 0x00;
